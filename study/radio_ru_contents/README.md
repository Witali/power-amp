...
- `index.html` - главная навигационная страница по годам со ссылками на
  годовые подстраницы и исходные JPEG-сканы годовых оглавлений.
- `years/<год>.html` - подстраницы оглавления по отдельным годам с таблицей
  статей, поиском и фильтрами.
